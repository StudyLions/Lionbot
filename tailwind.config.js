...
// Purpose: shadcn/ui design system - CSS variable colors, standard min-width breakpoints, animations
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Legacy colors kept for non-dashboard pages
      ...
      fontFamily: {
        sans: ["Inter", "Rubik", ...fontFamily.sans],
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
