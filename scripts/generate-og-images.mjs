...
const PAGES = [
  // --- Marketing / Public ---
  { slug: 'homepage', title: 'LionBot', subtitle: 'The #1 Discord Productivity Bot for any community', category: 'marketing' },
  { slug: 'features', title: 'Features', subtitle: 'Activity tracking, economy, pomodoro, leaderboards & more', category: 'marketing' },
  { slug: 'donate', title: 'Support LionBot', subtitle: 'Get LionGems for premium skins, gifts & server perks', category: 'marketing' },
  { slug: 'study', title: 'Productivity Timer', subtitle: 'Pomodoro, ambient sounds, and deep work tracking', category: 'marketing' },
  ...
  // --- Dashboard (Member) ---
  { slug: 'dashboard-overview', title: 'Dashboard', subtitle: 'Your personal productivity overview, stats & activity', category: 'dashboard' },
  ...
  { slug: 'dashboard-goals', title: 'Goals', subtitle: 'Set weekly and monthly productivity goals and track your progress', category: 'dashboard' },
  ...
  { slug: 'dashboard-session', title: 'Session', subtitle: 'Your current session overview and timer', category: 'dashboard' },
  { slug: 'dashboard-focus', title: 'Focus Mode', subtitle: 'Distraction-free productivity timer with ambient sounds', category: 'dashboard' },
  { slug: 'dashboard-history', title: 'Activity History', subtitle: 'Detailed breakdown of your past sessions', category: 'dashboard' },
  ...
  { slug: 'dashboard-rooms', title: 'Voice Rooms', subtitle: 'Browse and join active voice rooms', category: 'dashboard' },
  { slug: 'dashboard-voice-editor', title: 'Voice Time Editor', subtitle: 'Review and adjust your tracked voice hours', category: 'dashboard' },
  ...
  { slug: 'server-ranks', title: 'Ranks Editor', subtitle: 'Create and manage activity ranks with custom rewards', category: 'server' },
  ...
  { slug: 'server-schedule', title: 'Schedule', subtitle: 'Configure session schedules and automated events', category: 'server' },
  ...
  { slug: 'server-videochannels', title: 'Video Channels', subtitle: 'Configure camera-on voice rooms and video settings', category: 'server' },
  ...
  { slug: 'server-ambient-sounds', title: 'Ambient Sounds', subtitle: 'Configure background audio for voice channels', category: 'server' },
  { slug: 'server-leaderboard', title: 'Server Leaderboard', subtitle: 'View and configure your server activity leaderboard', category: 'server' },
  { slug: 'server-rooms', title: 'Room Config', subtitle: 'Set up tracked voice rooms and channel rules', category: 'server' },
  { slug: 'server-sticky-messages', title: 'Sticky Messages', subtitle: 'Pin auto-refreshing messages to channel tops', category: 'server' },
  { slug: 'server-voice-time-editor', title: 'Voice Time Editor', subtitle: 'Review and adjust member voice hours', category: 'server' },

  // --- Pet / LionGotchi ---
  { slug: 'pet-overview', title: 'Your LionGotchi', subtitle: 'Feed, play, and care for your virtual productivity companion', category: 'pet' },
