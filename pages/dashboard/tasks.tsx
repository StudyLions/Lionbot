            ...
            <div className="flex-1 min-w-0 max-w-3xl">
              ...
              <div className="flex gap-3 mb-6">
                ...
                <button
                  ...
                  className="px-5 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-xl text-sm font-medium transition-all active:scale-95 flex items-center gap-2"
                >
                  <Plus size={16} />
                  {adding ? "..." : "Add"}
                </button>
              ...
              {loading ? (
                ...
                <EmptyState
                  icon={<CheckSquare size={48} strokeWidth={1} className="text-gray-500" />}
                  title="No tasks yet"
                ...
                <div className="space-y-2">
                  {rootTasks.map((task) => (
                    <div key={task.id}>
                      <div
                        className={`bg-gray-800 rounded-xl border border-gray-700 p-4 flex items-center gap-3 group transition-all hover:border-gray-600 ${
                      ...
                      >
                        ...
                        <button
                          ...
                          className="opacity-0 group-hover:opacity-100 text-gray-500 hover:text-red-400 transition-all p-1.5 rounded hover:bg-red-500/10"
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
                      ...
                      {childTasks(task.id).map((child) => (
                        <div
                          key={child.id}
                          className={`ml-8 mt-1 bg-gray-800/50 rounded-lg border border-gray-700/50 p-3 flex items-center gap-3 group ${
                        ...
                        >
                          ...
                          <span
                            className={`flex-1 text-xs ${
                              child.completed ? "line-through text-gray-500" : "text-gray-300"
                            }`}
                          >
                            {child.content}
                          </span>
