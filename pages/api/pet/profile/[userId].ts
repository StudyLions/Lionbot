...
//          No auth required to view. Used by leaderboard,
//          friend visit, family members, and public profiles.
// ============================================================
import { prisma } from "@/utils/prisma"
import { apiHandler, parseBigInt } from "@/utils/apiHandler"
import { getRoomDefaults } from "@/utils/roomDefaults"

async function fetchPetVisualData(userId: bigint) {
